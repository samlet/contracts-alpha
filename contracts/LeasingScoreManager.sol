...
contract LeasingScoreManager {
    ...
    function indexAdmin(address admin) view returns (uint) {
    ...
    function validAdmin(address admin) view returns (bool) {
        return indexAdmin(admin) < adminList.length;
    }

    function indexCalculator(address calculator) view returns (uint) {
    ...
    function validCalculator(address calculator) view returns (bool) {
        return indexCalculator(calculator) < calculatorList.length;
    }

    function indexObserver(address observer) view returns (uint) {
    ...
    function validObserver(address observer) view returns (bool) {
    ...
    function queryAdmins() view public onlyAdmin returns (address[]) {
        return adminList;
    }

    function addCalculator(address calculator) public onlyAdmin {
    ...
    function removeCalculator(address calculator) public onlyAdmin {
    ...
    function queryCalculators() view public onlyCalculatorOrAdmin returns (address[]) {
        return calculatorList;
    }

    function addObserver(address observer) public onlyAdmin {
    ...
    function removeObserver(address observer) public onlyAdmin {
    ...
    function queryObservers() view public onlyObserverOrAdmin returns (address[]) {
        return observerList;
    }
